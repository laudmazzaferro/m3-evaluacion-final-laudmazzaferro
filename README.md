...
Web made with the react framework, it contains components like CharapterCard ,CharapterList, CharapterDetail, Filters and Footer.

the character detail URL is shareable, that is,
that if we visit that URL directly in the browser you can see the detail of the character.
